...
//        System.out.println(getCommonLength("abcdefg", "123abcdfge"));
//        System.out.println(getLCS_1("abcdefg", "123ab1cdfge"));
...
//        String str2 = new String("234dddabc45678");
    ...
    /**
     * 求2个字符串的最长公共子串的长度（子串和子序列是2个不同的概念，子串必须是相邻的字符，子序列则按顺序，但是不需要相邻）
     * 思路：
     ...
     * @return
     */
    private static String getLCS_1(String s, String t) {
        int p = s.length();
        int q = t.length();
     ...
     * @return
     */
    private static void getLCString(char[] str1, char[] str2) {
        int i, j;
        //2个字符串的长度
        int len1, len2;
        len1 = str1.length;

...
public class DES {
    ...
    private static final String DES_KEY = "linkflow";
    ...
    public static void main(String[] args) {
        String encrypyStr = DES.getInstance().encrypt("dw_1");
        System.out.println("encrypyStr = " + encrypyStr);
        String dencryptStr = DES.getInstance().dencrypt(encrypyStr);
        System.out.println("dencryptStr = " + dencryptStr);
	}
}

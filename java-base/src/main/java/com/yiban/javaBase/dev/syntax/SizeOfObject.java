...
/**
 * 对象占用字节大小工具类 
 * 该类要运行 首先需要用maven打包  然后通过如下命令运行测试类
 *  D:\source_code\java-project-1\java-base\target>java -javaagent:test.jar -XX:-UseCompressedOops -cp test.jar com.yiban.javaBase.dev.syntax.ObjectSizeTest
 * @author tianmai.fh

...
public class MysqlEntityUtil {
    ...
    private static final String URL = "jdbc:mysql://10.21.3.77:3306/test";
    private static final String NAME = "root";
    private static final String PASS = "120653";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private String packageOutPath = "com.yiban.mybatis.dev.entity";// 指定实体生成所在包的路径
    private String authorName = "xc";// 作者名字
    private String[] generateTables = new String[]{"student"};//指定需要生成的表的表名，全部生成设置为null

...
public class Tweet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6500968498313083426L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Tweet\",\"namespace\":\"com.yiban.serde.avro.entity\",\"doc\":\"A basic schema for storing Twitter messages\",\"fields\":[{\"name\":\"username\",\"type\":\"string\",\"doc\":\"Name of the user account on Twitter.com\"},{\"name\":\"text\",\"type\":\"string\",\"doc\":\"The content of the user's Twitter message\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"Unix epoch time in seconds\"}]}");
   ...
   */
  public static com.yiban.serde.avro.entity.Tweet.Builder newBuilder() {
    return new com.yiban.serde.avro.entity.Tweet.Builder();
  }
   ...
   * @return A new Tweet RecordBuilder
   */
  public static com.yiban.serde.avro.entity.Tweet.Builder newBuilder(com.yiban.serde.avro.entity.Tweet.Builder other) {
    return new com.yiban.serde.avro.entity.Tweet.Builder(other);
  }
   ...
   * @return A new Tweet RecordBuilder
   */
  public static com.yiban.serde.avro.entity.Tweet.Builder newBuilder(com.yiban.serde.avro.entity.Tweet other) {
    return new com.yiban.serde.avro.entity.Tweet.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tweet>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.yiban.serde.avro.entity.Tweet.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.yiban.serde.avro.entity.Tweet other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder setUsername(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder setText(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yiban.serde.avro.entity.Tweet.Builder clearTimestamp() {
